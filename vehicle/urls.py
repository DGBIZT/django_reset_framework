...
from vehicle.views import CarViewSet, MotoCreateAPIView, MotoListAPIView, MotoRetrieveAPIView, \
    MotoUpdateAPIView, MotoDestroyAPIView, MilageCreateAPIView, MotoMilageListAPIView, MilageListAPIView
